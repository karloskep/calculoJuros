		...
		if(parcelas<=10){
			...
			if(parcelas!=0){
				...
				if (parcelas==1){
					...
					gravarArq.printf("Valor da compra: R$"+valorTotal);
					gravarArq.printf("%nNúmero de parcelas: "+parcelas);
					gravarArq.printf("%nValor com juros: R$"+valorComJuros);
				
					
					
					valorParcela = (valorComJuros/parcelas);
					
					gravarArq.printf("%nValor da parcela: R$"+(valorParcela));
